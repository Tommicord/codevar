...
use crate::network::tls_cert::ServerName;
use crate::network::tls_connection::{CommonState, ConnectionState, IoState};
use crate::network::tls_connection_conf::ClientConfig;
...
impl TlsClientConnection {
    ...
    fn send_client_hello(&mut self) -> TlsResult<()> {
        ...
        if let Some(cookie) = &self.cookie {
            let mut c = Vec::new();
            crate::network::tls_codec::put_vec_u16(&mut c, cookie)?;
