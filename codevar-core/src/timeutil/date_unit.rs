...
impl_per! {
    ...
    Subsecond per {
        Second: [u32] u32|u64|u128|usize|i32|i64|i128|isize = 1_000_000_000; f32|f64 = 1_000_000_000.;
    }
    Minute per {
...
impl_partial_eq_ord! {
    Nanosecond {
        < Microsecond Millisecond Second Subsecond Minute Hour Day Week;
    }
    Microsecond {
        > Nanosecond;
        < Millisecond Second Subsecond Minute Hour Day Week;
    }
    Millisecond {
        > Nanosecond Microsecond;
        < Second Subsecond Minute Hour Day Week;
    }
    Second {
        > Nanosecond Microsecond Millisecond;
        < Subsecond Minute Hour Day Week;
    }
    Subsecond {
    ...
    Minute {
        > Nanosecond Microsecond Millisecond Second Subsecond;
        < Hour Day Week;
    }
    Hour {
        > Nanosecond Microsecond Millisecond Second Subsecond Minute;
        < Day Week;
    }
    Day {
        > Nanosecond Microsecond Millisecond Second Subsecond Minute Hour;
        < Week;
    }
    Week {
        > Nanosecond Microsecond Millisecond Second Subsecond Minute Hour Day;
    }
}
...
impl_partial_eq_ord_for_unit![Nanosecond Microsecond Millisecond Second Subsecond Minute Hour Day Week];
