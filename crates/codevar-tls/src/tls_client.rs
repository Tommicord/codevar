...
impl TlsClientConnection {
    ...
    fn send_client_hello(&mut self) -> TlsResult<()> {
        ...
        put_extension(
            ...
            &encode_supported_versions_client(
                &self
                    .config
                    .versions,
            )?,
    ...
    fn on_tls13_finished(&mut self, body: &[u8], raw: Vec<u8>) -> TlsResult<()> {
        ...
        let expected = schedule.server_finished_verify(
            &self
                .common
                .transcript
                .hash(),
            ...
            .send_ccs()?;
        {
            ...
            let vd = schedule.client_finished_verify(
                &self
                    .common
                    .transcript
                    .hash(),
    ...
    fn send_tls12_client_flight(&mut self) -> TlsResult<()> {
        ...
        let cke = encode_handshake(
            ...
            &ClientKeyExchangeEcdhe::encode(
                &kx.public
                    .key_exchange,
            )?,
        );
        self.common
            .send_handshake_raw(&cke)?;
